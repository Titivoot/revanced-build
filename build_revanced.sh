...
artifacts["revanced-integrations.apk"]="Titivoot/revanced-integrations app-release-unsigned .apk"
artifacts["revanced-patches.jar"]="Titivoot/revanced-patches revanced-patches .jar"
